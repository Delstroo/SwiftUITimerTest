...
class PromodoroModel: NSObject, ObservableObject, UNUserNotificationCenterDelegate  {
    ...
    func startTimer() {
        ...
        // MARK: - Calculating Total Seconds fore Timer Animation
